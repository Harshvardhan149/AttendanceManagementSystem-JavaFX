...
public class Home{
	...
	public void homeView(int id) throws SQLException {
		...
		x.setForeground(Color.decode("#c41218"));
		...
		min.setForeground(Color.decode("#0c0d0d"));
		min.setBounds(930, 0, 100, 20);
		...
		panel.setBackground(Color.decode("#c5cf0c"));
		frame.add(panel);
		//---------------------------------------------------------
		...
		students.setBackground(Color.decode("#056ea3"));
		students.setForeground(Color.decode("#060806"));
		frame.add(students);
		...
		addattendance.setBackground(Color.decode("#ba5041"));
		addattendance.setForeground(Color.decode("#060806"));
		...
		editattendance.setBackground(Color.decode("#8a5403"));
		editattendance.setForeground(Color.decode("#060806"));
		...
		teacher.setBackground(Color.decode("#47a192"));
		teacher.setForeground(Color.decode("#060806"));
		frame.add(teacher);
		...
		admin.setBackground(Color.decode("#70029c"));
		admin.setForeground(Color.decode("#060806"));
		frame.add(admin);
		...
		classes.setBackground(Color.decode("#647a35"));
		classes.setForeground(Color.decode("#060806"));
		frame.add(classes);
		...
		frame.getContentPane().setBackground(Color.decode("#065c4e"));
