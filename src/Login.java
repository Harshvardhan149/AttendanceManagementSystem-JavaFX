...
public class Login{
	...
	public void loginView() {
		...
		attendance.setForeground(Color.decode("#070803"));
		attendance.setBounds(65, 210, 400, 50);
		attendance.setFont(new Font("Verdana", Font.BOLD, 50));
		frame.add(attendance);
		JLabel management = new JLabel("MANAGEMENT");
		management.setForeground(Color.decode("#070803"));
		management.setBounds(70, 260, 400, 50);
		management.setFont(new Font("Verdana", Font.BOLD, 45));
		frame.add(management);
		JLabel system = new JLabel("SYSTEM");
		system.setForeground(Color.decode("#070803"));
		system.setBounds(150, 310, 400, 50);
		system.setFont(new Font("Verdana", Font.BOLD, 45));
		frame.add(system);
		//-------------------------------------------------------
		...
		min.setForeground(Color.decode("#02d9fa"));
		min.setBounds(930, 10, 100, 20);
		...
		lgn.setForeground(Color.decode("#010203"));
		lgn.setBounds(625, 100, 300, 75);
		...
		warning.setForeground(Color.decode("#f5aba9"));
		...
		login.setBackground(Color.decode("#77d1f2"));
		login.setForeground(Color.decode("#040505"));
		frame.add(login);
