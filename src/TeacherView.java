...
public class TeacherView {
	public void tcView(int id) throws SQLException {
		...
		addattendance.setBounds(175, 200, 650, 60);
		addattendance.setFont(btn);
		addattendance.setBackground(Color.decode("#e86454"));
		addattendance.setForeground(Color.decode("#070708"));
		...
		editattendance.setBounds(175, 350, 650, 60);
		editattendance.setFont(btn);
		editattendance.setBackground(Color.decode("#6a55f2"));
		editattendance.setForeground(Color.decode("#070708"));
